          ...
          <div className="space-y-5 flex flex-col">
            ...
            <div className="flex gap-2 mt-10">
              ...
              <div className="relative group">
                <button className="flex items-center gap-1 px-4 py- border rounded-lg hover:bg-pink-50 text-pink-600">
              ...
              {/* Compare */}
              <div className="relative group">
                <button className="flex items-center gap-1 px-4 py- border rounded-lg hover:bg-gray-50 text-gray-600">
