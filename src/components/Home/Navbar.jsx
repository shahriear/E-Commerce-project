...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 h-full bg-white z-40 w-4/5 max-w-xs shadow-lg transform transition-transform duration-300 ${
      ...
      {sidebarOpen && (
        <div
          className="fixed inset-0 bg bg-opacity-30 z-30"
          onClick={toggleSidebar}
        ></div>
      )}
    </>
