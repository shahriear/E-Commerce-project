...
//   // Popular products based on activeCategory
//   const { data: popularProducts, loading: popularLoading } =
//     useCategoryProducts(activeCategory);

//   // FeaturedProducts based on featuredCategory
//   const { data: featuredProducts, loading: featuredLoading } =
//     useCategoryProducts(featuredCategory || 'Fashion');
...
//     <div className="min-h-screen w-full bg-gray-50 container">
//       {/* Featured Categories */}
//       <FeaturedCategories onCategoryClick={setFeaturedCategory} />
...
//                 {featuredCategory.toUpperCase()} PRODUCTS
//               </h2>
//               {featuredLoading ? (
